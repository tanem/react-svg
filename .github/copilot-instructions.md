...
- In technical writing (commit messages, PR descriptions, documentation), use colons instead of em-dashes when introducing explanations. For example: "Missing feature: users need explicit configuration" rather than "Missing feature — users need explicit configuration".
