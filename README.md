...
<!-- prettier-ignore -->
| [<img src="https://avatars3.githubusercontent.com/u/464864?v=4" width="100px;"/><br /><sub><b>Tane Morgan</b></sub>](https://github.com/tanem)<br />[💻](https://github.com/tanem/react-svg/commits?author=tanem "Code") [📖](https://github.com/tanem/react-svg/commits?author=tanem "Documentation") [🚇](#infra-tanem "Infrastructure (Hosting, Build-Tools, etc)") [⚠️](https://github.com/tanem/react-svg/commits?author=tanem "Tests") [👀](#review-tanem "Reviewed Pull Requests") [🐛](https://github.com/tanem/react-svg/issues?q=author%3Atanem "Bug reports") [💡](#example-tanem "Examples") [🤔](#ideas-tanem "Ideas, Planning, & Feedback") |
| :---: |
